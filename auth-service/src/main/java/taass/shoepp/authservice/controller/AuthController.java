package taass.shoepp.authservice.controller;
...
import taass.shoepp.authservice.models.AuthenticationRequest;
import taass.shoepp.authservice.models.AuthenticationRequestGoogle;
import taass.shoepp.authservice.models.AuthenticationResponse;
import taass.shoepp.authservice.models.RegistrationRequest;
import taass.shoepp.authservice.repository.UserRepository;
import taass.shoepp.authservice.service.UserService;
import taass.shoepp.authservice.utility.JwtUtil;
import taass.shoepp.authservice.utility.RestUtility;

import javax.validation.Valid;

import java.util.Optional;

import static taass.shoepp.authservice.utility.RestUtility.HEADER_AUTH;
